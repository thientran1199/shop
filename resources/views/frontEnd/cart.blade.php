                        ...
                        @foreach($cart_datas as $cart_data)
                            ...
                            <tr>
                                <td class="cart_product">
                                    <a href=""><img src="{{ url(get_image_product($cart_data['products_id'])) }}" alt="" style="width: 100px;"></a>
                                </td>
                                ...
                                <td class="cart_quantity">
                                    <div class="cart_quantity_button">
                                        @if($cart_data['quantity'] >= 1)
                                            <a class="cart_quantity_down" href="{{ route('cart.update-quantity', ['products_id' => $cart_data['products_id'], 'action' => 'desc']) }}"> - </a>
                                        @endif
                                        <input class="cart_quantity_input" type="text" name="quantity" value="{{$cart_data['quantity'] }}" autocomplete="off" min="1" size="2">
                                        <a class="cart_quantity_up" href="{{ route('cart.update-quantity', ['products_id' => $cart_data['products_id'], 'action' => 'asc']) }}"> + </a>
                                    </div>
                                </td>
                                <td class="cart_total">
                                ...
                                <td class="cart_delete">
                                    <a class="cart_quantity_delete" href="{{url('/cart/deleteItem',$cart_data['products_id'])}}"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
