            ...
            <div class="col-sm-7">
                <form action="{{route('addToCart')}}" method="post" role="form">
                    ...
                    <div class="product-information"><!--/product-information-->
                        <img src="{{asset('home/images/product-details/new.jpg')}}" class="newarrival" alt="" />
                        ...
                        <span>
                            ...
                            <input type="text" name="quantity" value="{{$detail_product->quantity}}" id="quantity" />
                        ...
                        <a href=""><img src="{{asset('home/images/product-details/share.png')}}" class="share img-responsive"  alt="" /></a>
        ...
        <div class="category-tab shop-details-tab"><!--category-tab-->
            <div class="col-sm-12">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#companyprofile" data-toggle="tab">Tương Tự</a></li>
                ...
                <div class="tab-pane fade" id="reviews" >
                    <div class="col-sm-12">
                        ...
                        <form action="#">
                            ...
                            <b>Rating: </b> <img src="{{asset('home/images/product-details/rating.png')}}" alt="" />
