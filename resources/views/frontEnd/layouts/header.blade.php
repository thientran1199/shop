                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> 0775275597</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> thien1111999@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                        <li><a href="{{url('/viewcart')}}"><i class="fa fa-shopping-cart"></i> Cart</a><b>{{ count_items_in_cart() }}</b></li>
                            @if(Auth::check())
